...
@section('page-content')
    <form class="card m-5 mx-auto" style="width: 75%;" action="{{ route('admin.update', $book->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <x-input name="pengarang" label="Author" :value="old('pengarang', $book->pengarang)" required />
            <x-input name="penerbit" label="Publisher" :value="old('penerbit', $book->penerbit)" required />
